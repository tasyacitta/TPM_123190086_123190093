class ProductsModel {
  ...
  ProductsModel.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
        ...
        tagList = (json['tag_list'] as List?)?.map((dynamic e) => e as String).toList(),
        createdAt = json['created_at'] as String?,
        updatedAt = json['updated_at'] as String?,
        productApiUrl = json['product_api_url'] as String?,
        apiFeaturedImage = json['api_featured_image'] as String?,
        productColors = (json['product_colors'] as List?)?.map((dynamic e) => ProductColors.fromJson(e as Map<String,dynamic>)).toList();
